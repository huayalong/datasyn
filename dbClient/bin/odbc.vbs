...
'使用实例：安装：cscript odbc.vbs /Style:Install /FolderPath:d:\ShenTong\odbc  /DllName:OSCARODBC.dll
		  '卸载：cscript odbc.vbs /Style:UnInstall /DllName:OSCARODBC.dll
